...
import { SPDASHBOARD_SIDEBAR_BOTTOM_LINKS, SPDASHBOARD_SIDEBAR_LINKS } from '../../lib/consts/SPNavigation';
      ...
      <div className={classNames('bg-neutral-900 p-3 flex flex-col text-white transition-all', {
        ...
        <div className='flex items-center justify-between px-1 py-3'>
          <div className='flex items-center gap-2'>
            ...
            {expanded && (
              <span className='text-yellow-400 text-xl'>Supervisor</span>
            )}
        ...
        <div className='py-8 flex flex-1 flex-col gap-0.5'>
          {SPDASHBOARD_SIDEBAR_LINKS.map((item) => (
        ...
        <div className='flex flex-col gap-0.5 pt-2 border-t border-neutral-700'>
          {SPDASHBOARD_SIDEBAR_BOTTOM_LINKS.map((item) => (
            <SidebarLink key={item.key} item={item} />
          ))}
  ...
  return (
    <Link
      ...
      className={classNames(
        pathname === item.path ? 'text-yellow-300 bg-neutral-700' : 'text-neutral-400',
        linkClasses
      )}
    >
